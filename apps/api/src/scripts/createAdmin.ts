/*
  ...
  Postman:
  curl -X POST http://localhost:8080/api/v1/auth/login -H "Content-Type: application/json" -d '{"email":"admin@Glotrade.com","password":"admin123"}'
*/
...
async function createAdmin() {
  try {
    ...
    console.log("📧 Email: admin@Glotrade.com");
